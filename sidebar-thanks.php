...
<input type="text" name="zip" id="zipcodeInput" value="Zip Code" onfocus="if(this.value=='Zip Code') this.value='';" onblur="if(this.value=='') this.value='Zip Code';" /> <input type="submit" value="Go" id="go" />
</form>
</div></div>
...
<p><label class="fl">FOLLOW US</label><img src="/images/home/social.gif" usemap="#socialMap" class="social" width="106" border="0" height="20">
