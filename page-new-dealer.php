...
*/
    ...
    <div id="sms-container" >
        <div id="sms-form" >
            <h3>Send to Phone</h3>
            <form action="<?php bloginfo('url'); ?>" method="post" id="sms-fields" name="send-message-form" >
            ...
            <div class="dealer-two-col">
                ...
                <div class="dealer-lt-col">
                    ...
                    <div class="dealer-details">
                        ...
                        <div>
                            <a href="mailto:<?php echo $dealer_email; ?>" class="lt" onclick="_gaq.push(['_trackEvent', 'DealerLocator', 'Email']);"><span class="icons icon-envelope"></span><span class="the-words">Email dealer</span></a>
                            <a href="<?php echo $dealer_website; ?>" class="rt" target="_blank" onclick="_gaq.push(['_trackEvent', 'DealerLocator', 'Website']);"><span class="icons icon-map-pin-stroke"></span><span class="the-words">Dealer's Website</span></a>
                        </div>
                ...
                <div class="dealer-rt-col">
                    ...
                    <div class="dealer-visit-guide widge">
                        ...
                        <a href="<?php bloginfo('template_url'); ?>/images/brochure/Jacuzzi_Hottubs_Dealer_Visit_Checklist.pdf" class="black-button" onclick="_gaq.push(['_trackEvent', 'DealerLocator', 'Download-Guide']);" target="_blank">Download<div class="fs1" aria-hidden="true" data-icon="&#xe129;"><div class="arrow-cover-t"></div></div></a>
                    </div>
                    ...
                    <div class="dealer-request-quote widge gld">
                        ...
                        <a href="<?php bloginfo('url'); ?>/get-a-quote/" class="black-button" onclick="_gaq.push(['_trackEvent', 'DealerLocator', 'Get-Quote']);">Get My Quote<div class="fs1" aria-hidden="true" data-icon="&#xe127;"><div class="arrow-cover-l"></div></div></a>
                    </div>
                    <div class="dealer-brochure widge gld">
                        <h4>Jacuzzi Brochure</h4>
                        <p>40 Pages of<br />Facts &amp; Photos<br /><span>For Free</span></p>
                        <a href="<?php bloginfo('url'); ?>/request-brochure/" class="black-button" onclick="_gaq.push(['_trackEvent', 'DealerLocator', 'Get-Brochure']);">Get My Brochure<div class="fs1" aria-hidden="true" data-icon="&#xe127;"><div class="arrow-cover-l"></div></div></a>
                    </div>
