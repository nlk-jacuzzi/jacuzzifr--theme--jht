...
if ( isset($_POST['leaddata']) && !empty($_POST['leaddata']) ) {
	...
	$apiUrl = array(
		'live' => 'http://jacuzzi.aimbase.com/FormBuilder/api/Lead',
		'test' => 'http://jacuzziqa.aimbase.com/FormBuilder/api/Lead'
	);
...
<html>
	...
	<body>
		...
		<form action="#" method="post" id="addLeads">
			<textarea id="leaddata" name="leaddata" cols="100" rows="10" required="required" wrap="soft"><?=$thedata; ?></textarea><br />
