            ...
            <?php if ( $hasmore ) {
            	...
            	<div class="side">
                    ...
                    */ ?>
                    ...
                    <ul class="tub-menu-category greyln">
	                    <li><a href="<?php echo get_bloginfo('url'); ?>/6-person-hot-tub/" id="6Person">6+ Person</a></li>
	                    <li><a href="<?php echo get_bloginfo('url'); ?>/5-person-hot-tubs/" id="56People">5-6 People</a></li>
	                    ...
	                    <li><a href="http://staging.jacuzzihottubs.ca/collections/" id="Collections">Collections</a>
	                    	<ul>
	                    		...
	                    		<li><a href="<?php echo get_bloginfo('url'); ?>/j-lx/" id="JLX">J-LX</a></li>
	                    		<li><a href="<?php echo get_bloginfo('url'); ?>/j-200/" id="J200">J-200</a></li>
	                    	</ul>
	                    </li>
                    </ul>
                	...
                	<ul class="grid3">
						...
						if ( in_array($post->ID, array($usid, $caid)) ) { // HOT TUBS landing page
							...
							if ( function_exists('pll_get_post') ) {
								$usid = pll_get_post($post->ID, 'en');
								$caid = pll_get_post($post->ID, 'ca');
								echo '<!-- IDCHECK : USID '. $usid .' : CAID '. $caid .' -->';
							}
							if ( count($tubs) == 0 ) {
								if ( $post->post_parent ) {
									//
								} else {
									$tubs = $tubcats[$usid]['tubs']; //hack??
								}
							}
